jQuery(document).ready(function(){
	...
	/*	BxSlider Remove
	/* ---------------------------------------------------------------------- */
	// $(".pg-testimonials-6 .bx-controls-direction .bx-prev").empty();
	// $(".pg-testimonials-6 .bx-controls-direction .bx-next").empty();
	// $(".pg-testimonials-6 .bx-controls-direction .bx-next").append('<i class="fa fa-angle-right"></i>');
	// $(".pg-testimonials-6 .bx-controls-direction .bx-prev").append('<i class="fa fa-angle-left"></i>');
